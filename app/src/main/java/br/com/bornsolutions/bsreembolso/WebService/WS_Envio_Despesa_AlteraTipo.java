...
/**
 * Created by Guilherme on 05/10/2016.
 */
public class WS_Envio_Despesa_AlteraTipo extends AsyncTask<String, String, Boolean> {
    ...
    public WS_Envio_Despesa_AlteraTipo(Context context, CAD_VIAGEM_DESPESA _psDespesa, String _psUsuarioID, String _psUsuarioLogado, String _psTipoPesquisa) {
    ...
    private String SOAP_ACTION = "http://tempuri.org/prcAlteraTipoDespesa";
    private String METHOD_NAME = "prcAlteraTipoDespesa";
    ...
    protected Boolean doInBackground(String... params) {
        ...
        WebServiceMaster.Master_Web_03_prcAdicionaParametroWebService(request2, "_psTipoDespesa", String.valueOf(_gDespesa.getCVD_TIPO()));
