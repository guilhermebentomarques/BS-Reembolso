...
/**
 * Created by guilherme on 09/09/2016.
 */
public class WS_Envio_Despesa_Finalizada extends AsyncTask<String, String, Boolean> {
    ...
    public WS_Envio_Despesa_Finalizada(Context context, CAD_VIAGEM_DESPESA _psDespesa, String _psUsuarioID, String _psUsuarioLogado, String _psTipoPesquisa) {
    ...
    private String SOAP_ACTION = "http://tempuri.org/prcFinalizaDespesa";
    private String METHOD_NAME = "prcFinalizaDespesa";
