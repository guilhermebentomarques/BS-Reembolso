 ...
 */
public class WS_Deleta_DespesaItem extends AsyncTask<String, String, Boolean> {
    ...
    public WS_Deleta_DespesaItem(Context context, CAD_VIAGEM_DESPESA_ITEM _psDespesaItem, CAD_VIAGEM_DESPESA _psDespesa, String _psUsuarioID, String _psUsuarioLogado, String _psTipoPesquisa) {
    ...
    private String SOAP_ACTION = "http://tempuri.org/prcRemoveDespesaItem";
    private String METHOD_NAME = "prcRemoveDespesaItem";
